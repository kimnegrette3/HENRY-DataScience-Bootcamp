CREATE DATABASE HENRY; -- Creo database llamada henry
USE HENRY; 			   -- Seteo la database como default para uso en el resto del script 

CREATE TABLE IF NOT EXISTS carrera (
	carrera_id INT NOT NULL AUTO_INCREMENT, -- Id Autoincremental
    nombre VARCHAR(20) NOT NULL,
    PRIMARY KEY (carrera_id) -- Instanciamos la primary key
    );
    
CREATE TABLE IF NOT EXISTS instructores (
	instructor_id INT NOT NULL AUTO_INCREMENT,-- Para implementar el autoincrement, debe asignarse por norma esa columna como primary key 
...
CREATE TABLE IF NOT EXISTS cohorte (
    ...
    carrera_id INT NOT NULL, -- foreign key - No es necesario que lleve el mismo nombre que en su tabla de origen
    fecha_inicio DATE,
    fecha_fin DATE,
...
CREATE TABLE IF NOT EXISTS alumnos (
    ...
    -- Para ver las relaciones entre tablas: database, reverse engineer, escoger la db, next, next hasta que te saca el gráfico
    
    
    -- Ingresar datos a las tablas
    
    -- Insertar valores a la tabla carrera
  ...
  -- Insertar valores en la tabla instructores
  ...
  VALUES (25456879,'Antonio','Barrios','1981-7-9','2019-11-8');
	...
	INSERT INTO instructores (cedula, nombre, apellido, fecha_nacimiento, fecha_incorporacion)
	...
	SELECT * FROM cohorte;
    -- Insertar valores en la tabla cohorte
    INSERT INTO cohorte (cohorte_id, codigo, carrera_id, instructor_id, fecha_inicio, fecha_fin)
    ...
    INSERT INTO cohorte (codigo, carrera_id, instructor_id, fecha_inicio, fecha_fin)
	VALUES ('FT-1235',1,1,'2020-2-1','2020-6-30');
    
    -- Se insertan valores en la tabla alumnos
    SELECT * FROM alumnos;
    INSERT INTO alumnos (alumno_id, cedula, nombre, apellido, fecha_nacimiento, fecha_ingreso, cohorte_id)
